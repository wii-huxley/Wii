...
package com.huxley.wiisample.common.stickygridheaders;
...
public class StickyGridHeadersGridView extends GridView implements OnScrollListener,
    ...
    private void measureHeader() {
        ...
        if (params != null && params.height > 0) {
            ...
            heightMeasureSpec = MeasureSpec.makeMeasureSpec(0, UNSPECIFIED);
        }
        mStickiedHeader.measure(MeasureSpec.makeMeasureSpec(0,UNSPECIFIED), MeasureSpec.makeMeasureSpec(0,UNSPECIFIED));
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        for (int i = 0; i < headerPositions.size(); i++) {
            ...
            int heightMeasureSpec = MeasureSpec.makeMeasureSpec(0, UNSPECIFIED);
            header.measure(MeasureSpec.makeMeasureSpec(0,UNSPECIFIED),MeasureSpec.makeMeasureSpec(0,UNSPECIFIED));
