...
import com.huxley.wii.wii.cg.editInfo.EditInfoActivity;
import com.huxley.wii.wii.cg.editSong.EditSongActivity;
import com.huxley.wii.wii.cg.editText.EditTextActivity;
import com.huxley.wii.wii.cg.login.LoginActivity;
...
public class UIHelper extends YlUIHelper {
    ...
    public static class ViewHolders {
        ...
        public static void setNote(com.zhy.adapter.abslistview.ViewHolder holder, Note note) {
            switch (note.noteType) {
                case WiiConstant.NoteType.HIGH:
                    holder.getView(R.id.iv_high).setVisibility(View.VISIBLE);
                    holder.getView(R.id.tv_note).setVisibility(View.VISIBLE);
