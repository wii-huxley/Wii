package com.huxley.wii.yl.transitionsHelper;
...
import com.huxley.wii.yl.transitionsHelper.bean.InfoBean;
import com.huxley.wii.yl.transitionsHelper.method.InflateShowMethod;
import com.huxley.wii.yl.transitionsHelper.method.NoneShowMethod;
import com.huxley.wii.yl.transitionsHelper.method.ShowMethod;
import com.huxley.wii.yl.transitionsHelper.view.CirleAnimView;
...
public class TransitionsHelper {
    ...
    public static TransitionsHelper getInstance() {
        showMethod = null;
        if (INSTANCE == null) {
            synchronized (TransitionsHelper.class) {
                if (INSTANCE == null) {
                    INSTANCE = new TransitionsHelper();
                }
            }
        }
        return INSTANCE;
    ...
    public TransitionsHelper setShowMethod(ShowMethod showMethod) {
