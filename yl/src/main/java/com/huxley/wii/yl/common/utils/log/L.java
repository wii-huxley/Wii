...
public class L {
    ...
    public static String TAG_ROOT = "log_yl";


    public static void json(Object json) {
        json(Log.DEBUG, null, new Gson().toJson(json));
    }
    ...
    public static void json(int logLevel, String tag, String json) {
        if (LOG) {
            ...
            YlPrinter.println(logLevel, TextUtils.isEmpty(tag) ? TAG_ROOT : tag, formatJson);
        }
    }
    ...
    public static void xml(int logLevel, String tag, String xml) {
        if (LOG) {
            ...
            YlPrinter.println(logLevel, TextUtils.isEmpty(tag) ? TAG_ROOT : tag, formatXml);
        }
    }
    ...
    public static void error(String tag, Throwable throwable) {
        if (LOG) {
            ...
            YlPrinter.println(Log.ERROR, TextUtils.isEmpty(tag) ? TAG_ROOT : tag, formatError);
        }
    }
    ...
    private static void msg(int logLevel, String tag, String format, Object... args) {
        if (LOG) {
            ...
            YlPrinter.println(logLevel, TextUtils.isEmpty(tag) ? TAG_ROOT : tag, formatMsg);
        }
    }
